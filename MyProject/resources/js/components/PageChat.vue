      ...
      <drag-container>
        ...
        <template #content>
          <div class="create-channel-content">
            グループ名：
            <input type="text" v-model="group_name" 　placeholder="グループ名を入力してください" />
            <label
            ...
            >
              <img class="user-list-item-profile-img" :src="'storage/images/' + user.id + '.jpg'" />
        ...
        <template #actions="props">
          <span class="create-button" @click="props.close(), create()">作成</span>
